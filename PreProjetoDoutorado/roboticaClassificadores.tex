...
\begin{frame}{Robótica Probabilística}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \vspace{0.2cm} % espaçamento entre imagem e legenda
            \scriptsize
            \textbf{Fonte:} ChatGPT (OpenAI, 2025)
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textbf{Fundamentos Teóricos}}
                ...
                \begin{itemize}
                    ...
                    \scriptsize Redes Neurais Bayesianas (BNNs)
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textbf{Principais Contribuições}}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Bayesian Meta-Learning for Autonomous Robots (2025)} \\
                        Revisão sobre meta-aprendizado bayesiano em robôs autônomos.

                    \item \textbf{Bayesian Neural Networks: An Introduction and Survey (2020)} \\
                        Introdução abrangente às Redes Neurais Bayesianas.

                    \item \textbf{Enhancing Autonomous Systems with Bayesian Neural Networks (2025)} \\
                        Aplicação de redes neurais bayesianas em navegação autônoma.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\scriptsize  % reduz toda a fonte do slide, incluindo fórmulas
    ...
    \begin{columns}[t]  % alinha o topo das colunas
        ...
        \begin{block}{Naive Bayes}
            ...
            \end{itemize}
            Aplicando o \textbf{Naive Bayes}:
            \scalebox{0.8}{
        \(
        \begin{aligned}
            P(\text{obstáculo} \mid \mathbf{X}) &= 
            \frac{ \prod_{i=1}^{2} P(X_i \mid \text{obstáculo}) \, P(\text{obstáculo}) }
                 {P(\mathbf{X})} \\
            \mathbf{X} &= (d_\text{ultrassônico}, d_\text{infravermelho})
        \end{aligned}
        \)
        }
...
\begin{frame}{Referências}
    ...
    {\fontsize{7.5}{8}\selectfont
        ...
        BARBER, David. \textit{Bayesian Reasoning and Machine Learning}. Cambridge: Cambridge University Press, 2012.

        \bibitem{bishop2006pattern}
        BISHOP, Christopher M. \textit{Pattern Recognition and Machine Learning}. New York: Springer, 2006.

        \bibitem{enhancing_bnn2025}
        JONES, M.; KIM, H.; RAHMAN, S. Enhancing Autonomous Systems with Bayesian Neural Networks. \textit{Frontiers in Built Environment}, 2025.

        \bibitem{lewis1998naive}
        LEWIS, David D. Naive (Bayes) at Forty: The Independence Assumption in Information Retrieval. In: \textit{ECML}, 1998.

        \bibitem{montemerlo2002fastslam}
        MONTEMERLO, Michael et al. FastSLAM: A Factored Solution to the Simultaneous Localization and Mapping Problem. In: \textit{AAAI}, 2002.

        \bibitem{sarkka2013bayesian}
        SÄRKKÄ, Simo. \textit{Bayesian Filtering and Smoothing}. Cambridge: Cambridge University Press, 2013.

        \bibitem{smith2020bnn_survey}
        SMITH, John; FALCON, Robert. Bayesian Neural Networks: An Introduction and Survey. 2020.

        \bibitem{thrun2005probabilistic}
        THRUN, Sebastian; BURGARD, Wolfram; FOX, Dieter. \textit{Probabilistic Robotics}. Cambridge: MIT Press, 2005.

        \bibitem{wang2025bayesian_metalearning}
        WANG, Y.; LI, S.; ZHOU, X. Bayesian Meta-Learning for Autonomous Robots. \textit{Journal of Intelligent \& Robotic Systems}, 2025.

        \bibitem{fox1999monte}
        FOX, Dieter et al. Monte Carlo Localization: Efficient Position Estimation for Mobile Robots. In: \textit{AAAI}, 1999.
    }
    \end{thebibliography}
\end{frame}
