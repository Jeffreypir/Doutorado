...
-- Define o tipo de arquivo para .ino como 'arduino'
vim.api.nvim_create_autocmd({ "BufNewFile", "BufRead" }, {
	pattern = "*.ino",
	callback = function()
		vim.bo.filetype = "arduino" -- Define o tipo de arquivo como 'arduino'
	end,
})

-- Carrega o template ao criar um novo arquivo .ino
vim.api.nvim_create_autocmd("BufNewFile", {
	pattern = "*.ino",
	callback = function()
		-- Lê o conteúdo do template e insere no buffer
		vim.cmd("read $HOME/.config/nvim/after/template/template.ino")
